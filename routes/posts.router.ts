...
export default new Hono()
	...
	.post("/create", requireAuthentication, ...postsController.createPost)
	...
	.post("/quote/:postId", requireAuthentication, ...postsController.quotePost)
	...
	.post("/reply/:postId", requireAuthentication, ...postsController.replyToPost)
