...
export default (basePath: Hono) => {
	...
	basePath.get("/accept-req/{:requestId}", validator("param", requestApprovalParams), followRequestsController.acceptFollowRequest);
	...
	basePath.get("/reject-req/{:requestId}", validator("param", requestApprovalParams), followRequestsController.rejectFollowRequest);
	...
	basePath.put("/{:path}", validator("param", settingInteractParams), validator("query", updateSettingQuery), settingsController.updateSettingByPath);
	basePath.get("/{:path}", validator("param", settingInteractParams), settingsController.getSettingByPath);
};